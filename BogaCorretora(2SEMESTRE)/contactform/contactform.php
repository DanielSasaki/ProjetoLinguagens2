...
/***************** Configuration *****************/
  ...
  $contact_email_to = "binhu.kawa@gmail.com";
  ...
  // Error messages
  $contact_error_name = "Nome muito curto ou vazio";
  $contact_error_email = "Entre um email válido";
  $contact_error_subject = "Assunto muito curto ou vazio";
  $contact_error_message = "Mensagem muito curta ou vazia";
